...
~~~
docker run joramk/fc27-haproxy:1.8.4
~~~
...
## docker ps on successful start
    ...
    c2c6dc6cd27f        joramk/fc27-haproxy:1.8.4   "/docker-entrypoin..."   31 seconds ago      Up 30 seconds (healthy)   80/tcp, 443/tcp     fc27_haproxy
